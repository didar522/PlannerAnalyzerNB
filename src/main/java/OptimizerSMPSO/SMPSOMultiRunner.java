...
//import org.uma.jmetal.algorithm.multiobjective.smpso.SMPSOBuilder_Didar;
...
public SMPSOMultiRunner (problemDefinition tmp_problemDefinition){
	this.obj_problemDefinition = tmp_problemDefinition; 
}



public List<DoubleSolution> SMPSORunner()throws IOException {
//if (args.length != 1) {
...
for (int i = 0; i < problemList.size(); i++) {
  double mutationProbability = 1.0 / problemList.get(i).getProblem().getNumberOfVariables();
        ...
        algorithm = new SMPSOBuilder_Didar(problemList.get(i).getProblem(),
            new CrowdingDistanceArchive<IntegerSolution>(100))
            .setMutation(new IntegerPolynomialMutation(mutationProbability, mutationDistributionIndex))
