 ...
 * @author Didar
 */
public class EffortLineChartCreator {
    
    
public EffortLineChartCreator (ArrayList <resultTemplate> list_resultAnalyzer){
...
private DefaultCategoryDataset createDataset() {
        ...
        for (resultTemplate iterator: list_resultAnalyzer){
            dataset.addValue(iterator.prpftrRatio, series1, "gap of "+String.valueOf(iterator.daysForReplan)+" days");
            dataset.addValue(iterator.prpbugRatio, series2, "gap of "+String.valueOf(iterator.daysForReplan)+" days");
            dataset.addValue(iterator.prpimpRatio, series3, "gap of "+String.valueOf(iterator.daysForReplan)+" days");
...
//        renderer.setDrawShapes(true);
    ...
    String chartTitle="Proposed effort allotment per CR category while replanning in different intervals";
