 ...
 */
public class GenerateReferenceParetoSetAndFrontFromDoubleSolutions_Didar implements ExperimentComponent{
  private final Experiment<?, ?> experiment;
  
  List<DoubleSolution> transfernonDominatedSolutions; 

  public GenerateReferenceParetoSetAndFrontFromDoubleSolutions_Didar(Experiment<?, ?> experimentConfiguration) {
  ...
  public  void run() throws IOException {
    ...
    for (ExperimentProblem<?> problem : experiment.getProblemList()) {
      ...
      transfernonDominatedSolutions = nonDominatedSolutions; 
  ...
  private void writeReferenceFrontFile(
    ...
    String referenceFrontFileName = outputDirectoryName + "/" + problem.getName() + " value.csv" ;
  ...
  private void writeReferenceSetFile(
      String outputDirectoryName, Problem<?> problem, List<DoubleSolution> nonDominatedSolutions) throws IOException {
    String referenceSetFileName = outputDirectoryName + "/" + problem.getName() + " solution.csv" ;
  ...
  public  List<DoubleSolution> getTransferNonDominatedSolutions (){
