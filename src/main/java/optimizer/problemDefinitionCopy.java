...
public class problemDefinitionCopy extends AbstractIntegerProblem implements ConstrainedProblem<IntegerSolution> {
   ...
   */
  public problemDefinitionCopy(ArrayList<DataIssueTemplate> listEarlyOpen, double totalCapacity, int bugRatio, int ftrRatio, int impRatio) {
